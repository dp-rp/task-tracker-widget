...
def get_ado_generic(ado_work_item):
    ...
    return {
        ...
        "work_item_web_browser_link": f"https://dev.azure.com/recordpoint/{ado_work_item.fields['System.TeamProject']}/_sprints/backlog/{team_name_url_encoded}/{iteration_path_for_url}?workitem={ado_work_item.id}"
    }
